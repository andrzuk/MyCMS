...
define ('MODULE_NAME', 'sites');

$content_title = 'Opisy systemowe';
...
$model_object = new Sites_Model($db);

include APP_DIR . 'view' . '/' . MODULE_NAME . '.php';

$view_object = new Sites_View($db);
...
$list_columns = array(
	...
	array('db_name' => 'main_page',			'column_name' => 'Typ', 			'sorting' => 1),
