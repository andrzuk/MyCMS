...
define ('MODULE_NAME', 'reminds');

$content_title = 'Odzyskiwanie haseł';
...
$model_object = new Reminds_Model($db);

include APP_DIR . 'view' . '/' . MODULE_NAME . '.php';

$view_object = new Reminds_View($db);
...
$list_columns = array(
	...
	array('db_name' => 'remind_time',	'column_name' => 'Godzina', 	'sorting' => 1),
);
