...
define ('MODULE_NAME', 'registers');

$content_title = 'Rejestracje użytkowników';
...
$model_object = new Registers_Model($db);

include APP_DIR . 'view' . '/' . MODULE_NAME . '.php';

$view_object = new Registers_View($db);
...
$list_columns = array(
	...
	array('db_name' => 'result', 		'column_name' => 'Rezultat', 	'sorting' => 1),
	array('db_name' => 'register_time',	'column_name' => 'Godzina', 	'sorting' => 1),
);
