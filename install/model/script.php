	...
	array(
		'fill_data' => array(
			...
			"
				...
				(42, 'black_list_messages_limit', '5', 'limit wiadomości wysyłanych seryjnie powodujący dopisanie do czarnej listy', 1, 1, '$save_time'),
				(43, 'black_list_messages_authors', '\'Ensupede\'', 'lista zabronionych autorów wiadomości', 2, 1, '$save_time'),
				(44, 'links_length_min', '50', 'minimalna długość linku wyświetlanego w raporcie statystyk', 1, 1, '$save_time'),
				(45, 'links_length_max', '600', 'maksymalna długość linku wyświetlanego w raporcie statystyk', 1, 1, '$save_time'),
				(46, 'email_sender_name', 'Serwis $short_title - Mail Manager', 'nazwa konta e-mailowego serwisu', 1, 1, '$save_time'),
				(47, 'email_sender_address', '$email_sender_address', 'adres konta e-mailowego serwisu', 1, 1, '$save_time'),
				(48, 'email_admin_address', '$email_admin_address', 'adres e-mail administratora serwisu', 1, 1, '$save_time'),
				(49, 'email_report_address', '$email_report_address', 'adres e-mail odbiorcy raportów', 1, 1, '$save_time'),
				(50, 'email_report_subject', 'Raport serwisu $short_title', 'temat maila raportującego zdarzenie', 1, 1, '$save_time'),
				(51, 'email_report_body_1', 'Raport o zdarzeniu w serwisie $short_title', 'treść maila rapotującego - część przed zmiennymi', 2, 1, '$save_time'),
				(52, 'email_report_body_2', '(brak)', 'treść maila rapotującego - część za zmiennymi', 2, 1, '$save_time'),
				(53, 'email_createcnt_subject', 'Serwis $short_title - rejestracja konta', 'temat generowanego maila z potwierdzeniem rejestracji', 1, 1, '$save_time'),
				(54, 'email_createcnt_body_1', 'Dziękujemy za rejestrację w serwisie $short_title.\r\nParametry Twojego konta są następujące:', 'treść generowanego maila z potwierdzeniem rejestracji - przed parametrami', 2, 1, '$save_time'),
				(55, 'email_createcnt_body_2', 'Przypominamy, że hasło możesz zmienić po zalogowaniu, natomiast login musi pozostać nie zmieniony, gdyż jest identyfikatorem Twojego konta.', 'treść generowanego maila z potwierdzeniem rejestracji - po parametrach', 2, 1, '$save_time'),
				(56, 'email_editcnt_subject', 'Serwis $short_title - edycja konta użytkownika', 'temat generowanego maila edycji konta użytkownika', 2, 1, '$save_time'),
				(57, 'email_editcnt_body_1', 'Informujemy, że dokonałeś zmian w ustawieniach swojego konta.\r\nParametry Twojego konta są następujące:', 'wstęp e-maila do użytkownika o zmianie parametrów konta', 2, 1, '$save_time'),
				(58, 'email_editcnt_body_2', 'Przypominamy, że parametrów ''login'' i ''PESEL'' nie można zmienić, gdyż są one identyfikatorami konta w serwisie.', 'zakończenie e-maila do użytkownika o zmianie parametrów konta', 2, 1, '$save_time'),
				(59, 'email_remindpwd_subject', 'Serwis $short_title - nowe hasło do konta', 'temat generowanego maila z nowym hasłem', 1, 1, '$save_time'),
				(60, 'email_remindpwd_body_1', 'Na Twoją prośbę przesyłamy Ci hasło do konta w serwisie $short_title.\r\nOto Twój login, PESEL oraz nowe hasło:', 'treść generowanego maila z nowym hasłem - przed hasłem', 2, 1, '$save_time'),
				(61, 'email_remindpwd_body_2', 'Zaloguj się, a następnie zmień hasło na swoje własne.', 'treść generowanego maila z nowym hasłem - za hasłem', 2, 1, '$save_time');
			",
			"
